...
const FAQ = () => {
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <p>
        {t(
          'SmartGPT is a research prototype that uses GPT-3 to generate text based on user input.',
        )}
      </p>
      ...
      <p>
        {t(
          'Yes, SmartGPT does not store any API keys or personal data. Storage is done via your browsers local storage. We want to note that comes with its own risks (https://www.horangi.com/blog/misuse-of-local-storage). We are working on a better solution.',
        )}
      </p>
...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <p>
        {t(
          'We do not collect any personal data on this website. No chats, api keys, folders or other personal data is saved by this website.',
        )}{' '}
      </p>
      <p>
        {t(
          'We are not responsible for any content or generations created with SmartGPT.',
        )}
      </p>
    </div>
  );
